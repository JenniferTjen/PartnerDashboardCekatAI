...
import { Insights } from '../insights/SpeedInsights';
        ...
        <App>
            ...
            <div className="relative">
                ...
                <div className={`${themeConfig.navbar} main-container min-h-screen text-black dark:text-white-dark`}>
                    ...
                    <Sidebar />
                    {/* END SIDEBAR */}
                    <div className="main-content flex h-screen flex-col">
                        {/* BEGIN TOP NAVBAR */}
                        <Header />
                        {/* END TOP NAVBAR */}

                        {/* BEGIN CONTENT AREA */}
                         <div className={`${animation} animate__animated ${isDashboard ? '' : 'p-4'}`}>{children}</div>
                        {/* END CONTENT AREA */}
